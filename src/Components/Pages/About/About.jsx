...
<Helmet helmetData={helmetData}>
    ...
    <div className='h-fit'>
      <div className="bg h-[180px] w-full md:h-[400px] sm:h-[200px] bg-cover bg-no-repeat bg-center flex justify-center items-center">
        <p data-aos="zoom-out-up" className='xl:text-5xl md:text-4xl text-2xl font-bold border-b-2 border-red-600 p-2'>About Us</p>
      </div>
      <div className='my-4 px-2 text-justify container mx-auto p-4'>
        <h3 data-aos="fade-up"
     data-aos-duration="3000" className='p-2 my-6 text-white md:text-2xl text-xl text-center font-bold'>Welcome to EventHorizonX - Redefining Corporate Experiences</h3>
        <p data-aos="fade-up"
     data-aos-duration="3000">At EventHorizonX, we hold a fundamental belief: every corporate event is an opportunity for something extraordinary. We don't just plan events; we craft moments that linger in the hearts and minds of attendees long after the lights have dimmed. Our journey begins with your vision, and from there, we embark on a creative odyssey, fueled by an unwavering commitment to innovation, meticulous planning, and unparalleled execution.</p>
        <br />
        <p data-aos="fade-up"
     data-aos-duration="3000">Our mission is to transform your concepts and dreams into captivating realities, where every detail is a brushstroke on the canvas of your corporate narrative. We understand that your corporate events are not just gatherings but strategic opportunities, and it's our privilege to help you seize them in the most memorable way possible.</p>
      </div>
     ...
     data-aos-duration="3000" src={teamPicture} className="md:max-w-lg sm:max-w-sm p-4 rounded-lg shadow-2xl" />
          <div className='sm:p-1 p-4'>
            <h1 data-aos="fade-up"
     data-aos-duration="3000" className="sm:text-5xl text-4xl font-bold">Who We Are:</h1>
      ...
      <img data-aos="fade-up"
     data-aos-duration="3000" src={teamPicture2} className="xl:max-w-4xl md:max-w-2xl mx-auto sm:max-w-sm p-1 rounded-lg shadow-2xl" />
      <div className='container p-4 mx-auto'>
        <h3 className='text-2xl font-bold text-white my-6'>Weaving Together the Threads:</h3>
        <p data-aos="fade-up"
     data-aos-duration="3000" className='text-justify'>
