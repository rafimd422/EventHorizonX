...
<section className="m-4 md:m-8 text-gray-100">
	<div className="container mx-auto p-4 my-6 space-y-2 text-center">
		<h2 className="md:text-5xl text-4xl mb-4 font-bold text-primary">Built to empower every team</h2>
		<p className="text-gray-400 text-3xl font-bold border-b-2 border-red-600 p-3 w-fit mx-auto">Our Features</p>
	</div>
